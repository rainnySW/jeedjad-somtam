...
const localMenu = [
  ...
  { _id: "m11", name: "Nam Tok Moo (Spicy Grilled Pork Salad)", name_th: "น้ำตกหมู", price: 60, category: "Spicy Salad", image_url: "/menu/nam-tok-moo.jpg", description: "Grilled pork sliced and tossed with roasted rice powder, chili, mint, and lime juice.", description_th: "น้ำตกหมูย่างรสแซ่บ หอมข้าวคั่วและใบสะระแหน่", is_available: true },
  ...
  { _id: "m13", name: "Larb Moo (Spicy Minced Pork Salad)", name_th: "ลาบหมู", price: 60, category: "Spicy Salad", image_url: "/menu/larb-moo.jpg", description: "Minced pork salad mixed with fresh herbs, chili, lime, and roasted rice powder.", description_th: "ลาบหมูรสเด็ด หอมเครื่องเทศและข้าวคั่ว", is_available: true },
